...
package com.sophie.customkeyboard;
...
import com.sophie.sampleapp.MainActivity;
...
//                .setRequestedPreviewSize(1920, 1080)
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                Log.d("test", "surface view created");
                try {
                    if (ActivityCompat.checkSelfPermission(SoftKeyboard.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    }
                } catch (IOException e) {
                    e.printStackTrace();
